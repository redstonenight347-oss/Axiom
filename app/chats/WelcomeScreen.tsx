...
export function WelcomeScreen({ onSuggestionClick }: WelcomeScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center flex-1 py-24 animate-fade-in">
      ...
      <h2 className="text-3xl font-semibold bg-linear-to-r from-white via-white/90 to-white/60 bg-clip-text text-transparent mb-3 tracking-tight">
        How can I help you today?
      </h2>
      <p className="text-base text-white/35 mb-10 max-w-sm text-center leading-relaxed">
      ...
      <div className="flex flex-wrap justify-center gap-2.5">
        {WELCOME_SUGGESTIONS.map((s) => (
          <button
            ...
            className="group relative px-4 py-2.5 rounded-2xl text-sm text-white/60 border border-white/[0.07] bg-white/3 backdrop-blur-sm hover:border-purple-400/30 hover:text-white/90 hover:bg-white/6 transition-all duration-300 cursor-pointer"
          >
